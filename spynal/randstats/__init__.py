from spynal.randstats.randstats import one_sample_test, \
                                       ...
                                       paired_sample_association_test, \
                                       paired_sample_association_test_labels, \
...
from spynal.randstats.utils import tail_to_compare, resamples_to_pvalue, confint_to_indexes, \
                                   jackknife_to_pseudoval
